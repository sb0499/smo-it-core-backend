...
from app.api.routes import auth, tickets, inventarios, proyectos, usuarios, guardias, personas, consumibles
...
api_router.include_router(consumibles.router, prefix="/consumibles", tags=["consumibles"])
